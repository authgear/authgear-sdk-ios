...
class App: ObservableObject {
    ...
    func configure(clientId: String, endpoint: String, page: String, storageType: String, shareSessionWithSystemBrowser: Bool) {
        ...
        appDelegate.configureAuthgear(clientId: clientId, endpoint: endpoint, storageType: storageType, shareSessionWithSystemBrowser: shareSessionWithSystemBrowser)
